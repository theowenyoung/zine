...
pub const enable = if (builtin.is_test) false else options.enable_tracy;
pub const enable_allocation = enable and options.enable_tracy_allocation;
pub const enable_callstack = enable and options.enable_tracy_callstack;
pub const callstack_depth = if (enable_callstack and options.tracy_callstack_depth > 0) options.tracy_callstack_depth else 10;
